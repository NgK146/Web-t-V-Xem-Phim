          ...
          <div className="review-box">
            ...
            {!user ? (
              <div style={{
                ...
                <p style={{ fontSize: '16px', marginBottom: '10px' }}>🔒 Vui lòng đăng nhập để đánh giá</p>
              </div>
            ) : !reviewEligible ? (
              <div style={{
                padding: '20px',
                background: 'rgba(231,26,15,0.08)',
                borderRadius: '12px',
                border: '1px solid rgba(231,26,15,0.2)',
                textAlign: 'center',
                color: '#ff9999',
                marginBottom: '20px'
              }}>
                <p style={{ fontSize: '16px', marginBottom: '6px' }}>🎟️ {eligibilityReason || 'Bạn cần đặt vé thành công cho phim này mới được đánh giá'}</p>
                <p style={{ fontSize: '13px', color: '#888' }}>Hãy mua vé và xem phim trước khi chia sẻ cảm nghĩ nhé!</p>
              </div>
            ) : (
