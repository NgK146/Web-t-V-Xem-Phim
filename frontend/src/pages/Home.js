      ...
      <header className="cb-header">
        <div className="cb-header-top">
          <div className="cb-header-top-links">
            ...
            {(user?.role === 'staff' || user?.role === 'admin') && (
              <span style={{ cursor: 'pointer', color: '#facc15' }} onClick={() => navigate('/staff-checkin')}>🛡️ STAFF CHECK-IN</span>
            )}
        ...
        <div className="cb-header-main">
          ...
          <nav className="cb-nav">
            ...
            {(user?.role === 'staff' || user?.role === 'admin') && (
              <div className="cb-nav-link" style={{ color: '#facc15' }} onClick={() => navigate('/staff-checkin')}>CHECK-IN</div>
            )}
          </nav>
